...
export default function Navbar() {
  return (
    <nav className="gap-3 md:gap-6 flex items-center justify-center md:items-center md:justify-center w-full p-3 md:w-1/2 md:mx-auto bg-neutral-300 dark:bg-neutral-900 rounded-3xl">
      <Link
        href="/"
      ...
      >
        <h1 className="text-xs md:text-lg">Dashboard</h1>
      </Link>
      <Link
